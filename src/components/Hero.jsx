...
const Hero = () => {
  return (
    <section 
      id="home" 
      className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 section-padding pt-20"
    >
      <div className="text-center max-w-4xl mx-auto">
        ...
        <motion.p 
          ...
          className="text-base sm:text-lg text-gray-500 mb-8 md:mb-12 max-w-2xl mx-auto"
        >
        ...
        >
          <a 
            href="#projects" 
            className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 text-center"
          >
            View My Work
          </a>
          <a 
